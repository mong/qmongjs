import { select, scaleBand, scaleLinear, dsvFormat, max } from 'd3'
...
// the barchart
export const responsiv_bar_chart = function (container, figure_data, props, levels) {
  const { width, height, margin, delay_value = 1000, duration_value = 1000} = props
  const margin_px = {
