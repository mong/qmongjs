...
test("level_direction 0 with wrong order of level_green and level_yellow", () => {
  // This test should return an error since level_green is not between level_direction and level_yellow
  const config: Config = {
    level_direction: 0,
    level_green: 0.75,
    level_yellow: 0.5,
