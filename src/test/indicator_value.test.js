...
it("renders", () => {
  ...
  expect(container.querySelector("td h4").textContent).toBe(`${indicator_value_share} `);
  expect(
    container.querySelector("td .summary").textContent
     ).toBe(`${numerator} av ${data.denominator}`);
});
